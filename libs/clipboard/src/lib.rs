...
pub fn server_clip_file(
  ...
  match msg {
    ...
    ClipboardFile::FormatDataResponse {
      ...
      ret =
        server_format_data_response(context, conn_id, msg_flags, format_data);
      log::debug!(
...
extern "C" fn client_format_list(
  ...
  if conn_id == 0 {
    ...
    msg_channel.iter().for_each(|msg_channel| {
