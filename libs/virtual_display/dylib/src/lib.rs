  ...
  unsafe {
    {
      ...
      if win10::idd::InstallUpdate(
        full_install_path.as_ptr() as _,
...
pub fn close_device() {
  #[cfg(windows)]
  unsafe {
    win10::idd::DeviceClose(
      *H_SW_DEVICE.lock().unwrap() as win10::idd::HSWDEVICE
    );
